...
```markdown
![System Architecture]([images/system_architecture.png](https://github.com/Anuranj-P-M/Wireless-Audio-Notice-Board-System/blob/main/System%20Architecture.png))
```
